...
app = FastAPI(title="DeskHero", version="1.0.0", lifespan=lifespan)
...
@app.get("/locations")
def serve_locations() -> FileResponse:
    return FileResponse("app/static/locations.html")

@app.get("/reservations")
def serve_reservations() -> FileResponse:
    return FileResponse("app/static/reservations.html")
